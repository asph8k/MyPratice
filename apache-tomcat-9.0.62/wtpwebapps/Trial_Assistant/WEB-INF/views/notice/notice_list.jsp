              ...
              <div class="row">
                  ...
                  <div class=" side-bar">
                      ...
                      <ul class="list-unstyled templatemo-accordion">
                          <li class="pb-3">
                              <a id="notice-list-btn" class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                                  공지사항
                              </a>
                          </li>
                          <li class="pb-3">
                              <a id="assays-detail-btn" class="collapsed d-flex justify-content-between h3 text-decoration-none myInfo" href="#">
                                  조력자 안내
                              </a>
                          </li>
                          <li class="pb-3">
                              <a id="assays-process-btn" class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                                  조력자 신청 절차
                              </a>
                          </li>
                      </ul>
...
<script>
		$(function(){
		  ...
		  $('#notice-list-btn').click(function(){
			...
			$('#assays-detail-btn').click(function(){
				location.href="<c:url value ='/asssys/detail' />";
				console.log('조력자 안내 페이지로 이동~');
					});
			
			$('#assays-process-btn').click(function(){
				location.href="<c:url value='/asssys/process'/>";
				console.log('조력자 신청 절차 페이지로 이동~');
					});  
            ...
            <input type="text" placeholder="검색할 제목을 입력하세요..." /> -->
							<select class="form-control search-select" name="condition"
								...
								<option value="content"
									${pcv.paging.condition == 'content' ? 'selected' : ''}>내용</option>
					...
					<tbody style="border-top: 3px solid #e9ecef">
						...
						<c:forEach var="notice" items="${noticeList }">
							<tr>
								<td>${notice.noticeNum}</td>
								<td><a
									href="<c:url value='/notice/content/${notice.noticeNum }' />"
									class="link-a-style">${notice.noticeTitle }</a></td>
								<td>${notice.noticeWriter }</td>
