		...
		<div class="row">
			<div class="container-fluid py-3">
				...
				<form class="col-md-9 m-auto"
					action="<c:url value='/apply/ghRegistForm' />" name="ghRegistForm"
					...
					<div class="row">
						...
						<div class="form-group col-md-6 mb-3">
							<label for="inputname">이름</label> <input type="text"
								class="form-control mt-1" name="ghName"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>

						<div class="form-group col-md-6 mb-3">
							<label for="inputsocnum">주민등록번호</label> <input type="text"
								class="form-control mt-1" name="ghSocNum"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-6 mb-3">
							<label for="inputhomephonenum">집 전화번호</label> <input type="tel"
								class="form-control mt-1" name="ghHomeNum">
						</div>
						<div class="form-group col-md-6 mb-3">
							<label for="inputphonenum">휴대폰 번호</label> <input type="tel"
								class="form-control mt-1" name="ghPhoneNum"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-6 mb-3">
							<label for="inputjob">직업</label> <input type="text"
								class="form-control mt-1" name="ghJob"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
						<div class="form-group col-md-6 mb-3">
							<label for="inputemail">이메일</label> <input type="email"
								class="form-control mt-1" name="ghEmail"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-6 mb-3">
							<label for="inputhelyear">조력자 연도</label> <input type="text"
								class="form-control mt-1" id="hel-year" name="hel-year">
						</div>

						<div class="form-group col-md-6 mb-3">
							<label for="inputhel-srttn">조력자 구분</label><span id="gene-num-msg">
								*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
							...
							<div id="hp-ge-radio">
								문서<input type="radio" name="ghSrttn" id="document"
									value="document">
							</div>
							<div id="hp-ge-radio">
							...
							<div id="hp-ge-radio">
								경매<input type="radio" name="ghSrttn" id="auction"
									value="auction">
							</div>
					...
					<div class="row">
						<div class="form-group col-md-6 mb-3">
							<label for="inputbsnsnum">사업자 번호</label> <input type="text"
								class="form-control mt-1" name="ghBsnsNum"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
						<div class="form-group col-md-6 mb-3">
							<label for="inputfax">팩스</label> <input type="text"
								class="form-control mt-1" name="ghFax">
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-6 mb-3">
							<label for="inputofcname">사무소명</label> <input type="text"
								class="form-control mt-1" name="ghOfcName"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
						<div class="form-group col-md-6 mb-3">
							<label for="inputofcnum">사무소 번호</label> <input type="text"
								class="form-control mt-1" name="ghOfcNum"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
					</div>
					...
					<div class="mb-3">
						<label for="inputacaback">학력</label><span id="gene-num-msg">
							*필수 사항입니다.</span>
						<!--자바스크립트에서 추가-->
						<textarea class="form-control mt-1" id="aca-back"
							name="ghAcadBack" rows="10"></textarea>
						...
						<div class="mb-3">
							<label for="inputcarrer">경력</label><span id="gene-num-msg">
								*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
							<textarea class="form-control mt-1" id="carrer" name="ghCarrer"
								rows="10"></textarea>
						...
						<div class="mb-3">
							<label for="inputcarrer">학력,경력 파일</label> <input
								...
								aria-label="Upload" name="File"> <span id="gene-num-msg">*zip파일만
								업로드 가능합니다.</span>
						</div>
					...
					<div class="row">
						<div class="form-group col-md-6 mb-3">
							<label for="inputbank">입금 은행</label> <input type="text"
								class="form-control mt-1" id="bank" name="ghBank"> <span
								id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
						<div class="form-group col-md-6 mb-3">
							<label for="inputacchol">예금주</label> <input type="text"
								class="form-control mt-1" id="acc-hol" name="ghAccHol">
							<span id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>

						<div class="form-group col-md-6 mb-3">
							<label for="inputbanknum">계좌번호</label> <input type="text"
								class="form-control mt-1" id="acc-hol" name="ghBankNum">
							<span id="gene-num-msg">*필수 사항입니다.</span>
							<!--자바스크립트에서 추가-->
						</div>
					</div>
					...
					<div class="form-group">
						<label for="addr-num">주소</label> <span id="gene-num-msg">*필수
							사항입니다.</span>
						<!--자바스크립트에서 추가-->
						<div class="input-group">
							<input type="text" name="ghPostNum" class="form-control"
								id="ghPostNum" placeholder="우편번호" readonly>
					...
					<input type="text" name="ghAddr" class="form-control" id="ghAddr"
						placeholder="기본주소"> <input type="text" name="ghDtlAddr"
						class="form-control" id="ghDtlAddr" placeholder="상세주소"> 
						<input
	...
	<section class="py-5">
		<div class="container my-4">
			...
			<div class="titlefoot col mt-2">
				<button type="button" class="btn btn-secondary btn-lg px-3 gh-btn"
					id="ghPrevBtn">이전</button>
				<button type="button" class="btn btn-secondary btn-lg px-3 gh-btn"
					id="ghNextBtn">다음</button>
			</div>
...
<script>
    	...
    	$(function() {
			...
			$('#ghNextBtn').click(function() {
				...
				file = file.slicke(file.indexOf('.')+1).toLowerCase(); 
				console.log(file);
