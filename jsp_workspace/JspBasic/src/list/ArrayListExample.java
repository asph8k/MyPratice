...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//한번에 객체 많이 추가하기
		Collections.addAll(score, 78, 100, 88, 97, 100, 20, 14);
...
//		System.out.println(score);
		...
		Collections.sort(score, Collections.reverseOrder()); //정렬과 역순 한번에 해결
		System.out.println(score);
		
		//두 요소의 위치를 교체 - swap(리스트, i(인덱스), j(인덱스))
